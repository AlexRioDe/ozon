...
gulp.task('copyMp3', function() {
    return gulp.src([mp3Source])
        .pipe(plumber())
        .pipe(gulp.dest(buildMp3Dest));
});
...
gulp.task('build', gulp.series('clean', 'template', 'app-css', 'compressJS', 'copyImages', 'copyMp3', 'copyFonts', 'copySitemapAndRobots' ));
